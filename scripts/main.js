...
function main() {
  ...
  const name = "Kaique Silva";
  const socialMediaUserName = "captain_silva";
  const linkTwitter = "https://twitter.com/";
  const linkInstagram = "https://www.facebook.com/";
  const gender = "Masculino";
  const location = "Higienópolis";
  ...
  if (verifyHome && verifyHome.innerText == 'Bem-vindo!') {
    ...
    let textAlert = 'Sou Kaique Silva\n';
    textAlert = textAlert + 'Polo Higienópolis/SP - TADS/Mackenzie\n'
